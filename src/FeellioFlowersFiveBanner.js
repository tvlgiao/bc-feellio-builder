...
class FeellioFlowersFiveBannerItemFive extends React.Component {
    ...
    render() {
        const { img5, alt5, link5, title5 } = this.props;
        return (
            <form>
                <div className="form-group">
...
class FeellioFlowersFiveBanner extends BaseSectionConfig {
    ...
    constructor(props) {
        ...
        this.state = this.getStateFromLocalStorage() || {
            img1: 'https://cdn11.bigcommerce.com/s-agzbp14fso/product_images/uploaded_images/feellio-flowers-banner-01.jpg',
            alt1: 'feellio-flowers-banner-01.jpg',
            link1: '#',
            title1: '',
            img2: 'https://cdn11.bigcommerce.com/s-agzbp14fso/product_images/uploaded_images/feellio-flowers-banner-02.jpg',
            alt2: 'feellio-flowers-banner-02.jpg',
            link2: '#',
            title2: '',
            img3: 'https://cdn11.bigcommerce.com/s-agzbp14fso/product_images/uploaded_images/feellio-flowers-banner-03.jpg',
            alt3: 'feellio-flowers-banner-03.jpg',
            link3: '#',
            title3: '',
            img4: 'https://cdn11.bigcommerce.com/s-agzbp14fso/product_images/uploaded_images/feellio-flowers-banner-04.jpg',
            alt4: 'feellio-flowers-banner-04.jpg',
            link4: '#',
            title4: '',
            img5: 'https://cdn11.bigcommerce.com/s-agzbp14fso/product_images/uploaded_images/feellio-flowers-banner-05.jpg',
