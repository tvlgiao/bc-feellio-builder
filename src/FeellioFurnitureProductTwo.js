...
class FeellioFurnitureProductTwo extends BaseSectionConfig {
    defaultTitle = "Feellio Furniture Product Two";
    scopeName = "FeellioFurnitureProductTwo";
    ...
    render() {
        ...
        return (
            <SectionConfigLayout elClass="FeellioFurnitureProductTwo" title={this.title} sectionKey={this.sectionKey}
                panels={[
                    {
                        title: "General",
...
export default FeellioFurnitureProductTwo;
